...
import 'package:flutter_client_control/models/client.dart';
import 'package:flutter_client_control/models/client_type.dart';
import 'package:flutter_client_control/models/clients.dart';
import 'package:flutter_client_control/models/types.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<Clients>(
        builder: (BuildContext context, Clients listClients, Widget? widget) {
          return ListView.builder(
            itemCount: listClients.clients.length,
            itemBuilder: (context, index) {
              return Dismissible(
                key: UniqueKey(),
                background: Container(color: Colors.red),
                child: ListTile(
                  leading: Icon(listClients.clients[index].type.icon),
                  title: Text(
                    '${listClients.clients[index].name} (${listClients.clients[index].type.name})',
                  ),
