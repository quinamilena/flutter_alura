...
import 'package:flutter_diario/screens/home_screen/widgets/home_screen_list.dart';
    ...
    SharedPreferences.getInstance()
        .then((prefs) {
          ...
          if (token != null && email != null && id != null) {
            ...
            service.getAll(token: token, id: id.toString()).then((
              List<Journal> listJournal,
            ) {
              List<Journal> journals = listJournal;
